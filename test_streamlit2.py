...
nrj_new = nrj.drop(labels = ['Date - Heure','TCO Thermique (%)', 'TCH Thermique (%)','TCO Nucléaire (%)',
                            ...
                            'TCH Hydraulique (%)','TCO Bioénergies (%)','TCH Bioénergies (%)', 'Ech. physiques (MW)','Column 26','Année'], axis = 1)
...
temperature_et_conso_2016_a_2020[temperature_et_conso_2016_a_2020.columns] = pd.DataFrame(preprocessing.StandardScaler().fit_transform(temperature_et_conso_2016_a_2019))
